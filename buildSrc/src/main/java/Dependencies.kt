...
object Deps {
  ...
  const val lifeCycleMethod       = "android.arch.lifecycle:extensions:${Versions.androidLifecycleVersion}"
  const val coreCoroutines        = "org.jetbrains.kotlinx:kotlinx-coroutines-core:${Versions.coroutinesVersion}"
